 ...
 * identificati univocamente da un indice intero compreso tra 0 e n-1 (dove n � il numero di vertici
 * del grafo). 
 ...
 * <p>
 * Nota Bene: Alcuni metodi non sono applicabili a tutti i tipi di grafo (ad es., la visita BFS �
...
public interface Graph {
	 ...
	 * @return <tt>true</tt> il vertice � contenuto nel grafo, <tt>false</tt> altrimenti.
	 */
	 ...
	 * <p>
	 * NB: se il grafo � diretto, ne considera anche la direzione.
	 * @param sourceVertexIndex il vertice da cui esce l'arco.
	 * @param targetVertexIndex il vertice nel quale entra l'arco.
	...
	/**
	 * Restituisce <tt>true</tt> se il grafo � diretto, <tt>false</tt> altrimenti.
	 * @return <tt>true</tt> se il grafo � diretto, <tt>false</tt> altrimenti.
	 */
	...
	/**
	 * Restituisce <tt>true</tt> se il grafo � un Directed Acyclic Graph, <tt>false</tt> altrimenti.
	 * @return <tt>true</tt> se il grafo � un DAG, <tt>false</tt> altrimenti.
	 */
	...
	/**
	 * Esegue una visita in profondit� (DFS) singola del grafo, e restituisce un oggetto di tipo 
	 * <code>VisitForest</code> che rappresenta l'albero di visita.
	 * @param startingVertex il source vertex.
	 * @return l'albero di visita.
	 * @see VisitForest
	...
	/**
	 * Calcola e restituisce un ordinamento topologico di <code>this</code> con l'algoritmo di Kosaraju.
